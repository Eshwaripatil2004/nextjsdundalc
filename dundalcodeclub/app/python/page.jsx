          ...
          >
            ...
            <section className="p-5 bg-orange-400 rounded-md mx-2 text-center">
              ...
              <div className="content p-4">
                <h2 className="font-bold text-start text-xl">Introduction to Python</h2>
                <p className="text-start">
                  Create animations, apps, and interactive stories by adding
                  code, costumes, and sounds.
                </p>
              </div>
            </section>
            ...
            <section className="p-5 bg-blue-200 rounded-md mx-2 text-center">
              ...
              />
              <div className="content p-4">
                <h2 className="font-bold text-xl text-start">More Python</h2>
                <p className="text-start">
